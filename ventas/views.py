...
class GenerarDocumentoConfirmacionView(LoginRequiredMixin, DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Procesar cada plantilla y generar HTML (orden: Vuelo, Hospedaje, Traslado, Genérica)
        plantillas_html = []
            ...
            if tipo == 'VUELO_UNICO':
                ...
                for traslado in traslados_list:
                    if isinstance(traslado, dict):
                        ...
                        plantillas_html.append('<div class="seccion-traslado-pdf">' + card_html + '</div>')
                        added = True
                if not added:
...
class ExportarComisionesExcelView(LoginRequiredMixin, View):
    ...
    def get(self, request, pk):
        ...
        total_pagado_usd = Decimal('0.00')
        total_comision_usd = Decimal('0.00')
        
        # Color para filas USD (amarillo claro)
