...
def generate_cotizacion_pdf(cotizacion):
    ...
    # ==================== LAYOUT DE DOS COLUMNAS SIMPLE ====================
    # Usar un enfoque SIMPLE sin tablas anidadas
    # Primero agregamos el contenido izquierdo directamente
    ...
    # Luego agregamos los sidebars uno por uno
    story.extend(sidebar1)
    story.append(Spacer(1, 0.4*cm))
    story.extend(sidebar2)
    story.append(Spacer(1, 0.4*cm))
    story.extend(sidebar3)
